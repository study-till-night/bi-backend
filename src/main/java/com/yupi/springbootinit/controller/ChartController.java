...
public class ChartController {
     ...
     * 智能分析 使用线程池实现异步
     *
     * @param excelData excel文件
     * @param genChartByAiRequest   dto对象
     * @return  结果
     */
    ...
    public BaseResponse<AiResponseVO> genAiChartByThread(@RequestPart("file") MultipartFile excelData,
        ...
        ThrowUtils.throwIf(StringUtils.isAnyBlank(name, goal, chartType), ErrorCode.PARAMS_ERROR, "图表请求参数不全");

        // 返回包含ai回复消息的vo
        return ResultUtils.success(chartService.getAiResult(excelData, genChartByAiRequest, request));
    }
    /**
     * 智能分析 使用消息队列实现异步
     *
    ...
    public BaseResponse<AiResponseVO> genAiChartByMq(@RequestPart("file") MultipartFile excelData,
        ...
        // 返回包含ai回复消息的vo
        return ResultUtils.success(chartService.getAiResultByMq(excelData, genChartByAiRequest, request));
    }
    /**
     * 获取查询包装类
     *
